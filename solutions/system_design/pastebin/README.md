...
We probably wouldn't want to store the pastes content in the relational store directly, as the reads per second average rate requires a retrieval time of roughly 25 ms (40 reads per sec). 
